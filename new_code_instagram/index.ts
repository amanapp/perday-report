...
import q2 from './src/routes/user/q2'
import q3 from './src/routes/user/q3'
import q4 from './src/routes/user/q4'
...
//q2
app.get('/q2',verifyToken,q2)
//q3
app.get('/q3',verifyToken,q3)
//q3
app.get('/q4',verifyToken,q4)
...
// post comments
app.post('/post/comment',verifyToken ,postcomment)
// post likes 
app.post('/post/like',verifyToken ,postlike)
